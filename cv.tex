...
As a lead consultant, I've worked on dozens of research projects across finance, media, security, the public sector, education and 
...
As a founding director, I helped design and build the product, plus taken a lead in liaising with the commercial team,
...
{As co-founder and CTO, I led a wildly ambitious project to develop a complete stack for mobile robotics from
a Linux-based operating system through a peer-to-peer UDP-based network protocol and middleware library up to a 3D
...
\begin{rSubsection}{Ad server}{2012 - 2013}{Lead engineer}{Java, Hadoop, HBase, Play, Bootstrap}
...
Dev tools & git, Ant, Make, Maven, Doxygen, JUnit, Jenkins, Github3 \\
