...
Mobile \& gaming & Unity 3D, iOS, Android, PhoneGap, jQuery Mobile \\
Operating System & Linux, GNU userspace, Docker, Ngingx, Exim \\
\end{tabular}
...
\item Scottish Government/NHS Scotland-backed project to develop tools for mental well-being
\item Rich single page application in AngularJS and D3, deployed via Docker and Sinatra
\item Backend aggregating data from Jawbone Up, Fitbit and various quantitied self apps
